...
const data = [
  ...
  },
  {
    ...
    title: "Blog-Website",
    description:
      "My blog website hosts regularly updated posts or articles in a chronological order. These posts are typically written by an individual or a group of authors on various topics of interest.",
  ...
  },
  {
    ...
    description:
      "My personal to-do app has been designed to help individuals manage their tasks, goals, and responsibilities. I provide a user-friendly interface that allows you to create a list of tasks or projects, set due dates, and track your progress towards completion.",
  ...
  },
  {
    ...
    description:
      "Ticket Tracker app helps teams manage their tasks and projects efficiently, manage ticket data, and keep track of project progress. Teams can create tickets that include relevant information such as title, description, priority level, deadline, and any other relevant notes.",
